...
export const FREEBIES: Record<FreebieId, FreebieConfig> = {
  ...
  'template-speedtolead': {
    ...
    emailIntro: 'Zoals beloofd: de Speed-to-Lead Quick Course staat klaar. Het complete systeem, de zeven valkuilen, en de templates om vandaag te starten.',
    emailBullets: [
      'Begin bij niveau 1 op de voorlaatste pagina: de twee templates als opgeslagen antwoord in je mailprogramma. Twintig minuten werk, vandaag nog resultaat.',
      'Lees daarna de zeven valkuilen. Grote kans dat je er minstens twee herkent, en die twee kosten je nu elke week aanvragen.',
    ],
  },
}
