...
//
// LET OP: dit bestand staat hier ongewijzigd zoals originkit.dev het uitlevert,
// zodat een latere update er zonder merge-werk overheen kan. Alle aanpassingen
// voor deze site (positionering, merkkleuren, reduced motion) staan in
// components/ui/dot-matrix-bg.tsx en worden als props doorgegeven.
"use client";
