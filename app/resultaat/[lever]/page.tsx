...
const nl: Record<string, LeverData> = {
  tijd: {
    ...
    primaryHref: '/#contact',
    secondaryCta: 'Bekijk het actiehandboek · €97',
    secondaryHref: '/actiehandboek',
  },
  team: {
  ...
  opvolging: {
    ...
    primaryCta: 'Bekijk het actiehandboek · €97',
    primaryHref: '/actiehandboek',
...
const en: Record<string, LeverData> = {
  tijd: {
    ...
    primaryHref: '/#contact',
    secondaryCta: 'Get the handbook · €97',
    secondaryHref: '/actiehandboek',
  },
  team: {
  ...
  opvolging: {
    ...
    primaryCta: 'Get the handbook · €97',
    primaryHref: '/actiehandboek',
