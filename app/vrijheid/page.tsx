...
const STAPPEN = [
  'Noteer wat je deze week deed, ook de kleine terugkerende taken',
  'Kies er één uit: de taak die het vaakst terugkwam en het snelst over te dragen is',
  'Leg de criteria vast, zodat "niemand doet het zoals ik" geen excuus meer is',
  'Spreek een testperiode van twee weken af, met ruimte voor fouten',
]

export default function VrijheidPage() {
  useEffect(() => {
    if (typeof window !== 'undefined' && (window as any).fbq) {
      (window as any).fbq('track', 'ViewContent', { content_name: 'vrijheid' })
    }
  }, [])
  ...
  return (
    <div style={{ background: '#faf9f5', color: '#3d3929', fontFamily: 'var(--font-sans)', minHeight: '100vh' }}>
      ...
      >
        ...
        >
          De <em style={{ color: '#c96442' }}>80%-test</em>
        </h1>
        ...
        >
          De checklist waarmee je in tien minuten de taken vindt die iemand anders voor 80% even goed kan als jij.
        </p>

        <div className="relative z-10 w-full">
          <FreebieOptinForm freebie="vrijheid" />
        </div>
      </section>
